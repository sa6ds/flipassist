        ...
        <div key={index} className="my-8">
          <div className="mt-1 flex">
            {product.category === "Sneaker" ? (
              <Image src={sneakerIcon} alt="Shoe Icon" className="not-highlightable w-6" />
            ) : product.category === "Clothing" ? (
              <Image src={clothingIcon} alt="Shirt Icon" className="not-highlightable w-6" />
            ) : product.category === "Collectible" ? (
              <Image src={collectibleIcon} alt="Collectible Icon" className="not-highlightable w-6" />
            ) : (
              <Image src={packageIcon} alt="Package Icon" className="not-highlightable w-6" />
            )}
