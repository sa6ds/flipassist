export default function Privacy() {
  return (
    <div>
      <div className="container mx-auto mb-12 max-w-7xl md:mb-32">
        {/* TODO: ADD NAVBAR */}
        <div className="mt-10 flex justify-center">
          <div className="mx-10 ">
            ...
            <h2 className="mt-12 text-2xl font-bold">Consent</h2>
            <p className="mt-1">
            ...
            <h2 className="mt-10 text-2xl font-bold">Log Files</h2>
            <p className="mt-1">
              Retailed follows a standard procedure of using log files. These
            ...
            <p className="mt-1">
              Like any other website, Retailed uses &apos;cookies&apos;. These
            ...
            <p className="mt-1">
              ...
              the advertising partners of Retailed.
            </p>
            <p className="mt-4">
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on Retailed, which
            ...
            <p className="mt-4">
              Note that Retailed has no access to or control over these cookies
            ...
            <p className="mt-1">
              Retailed&apos;s Privacy Policy does not apply to other advertisers
            ...
            <h2 className="mt-10 text-2xl font-bold">CCPA Privacy Rights</h2>
            <p className="mt-1">
            ...
            <p className="mt-4">
              Retailed does not knowingly collect any Personal Identifiable
