          ...
          <div className="flex justify-center">
            <div className="mx-10">
              ...
              <p className="mt-4">
                ...
                respective advertisements and links that appear on Retailed,
              ...
              <p className="mt-4">
                Note that Retailed has no access to or control over these
              ...
              <p className="mt-1">
                Retailed&apos;s Privacy Policy does not apply to other
